...
//    RCC_APB1PeriphResetCmd(RCC_APB1Periph_CAN1, DISABLE);
    ...
    CAN_InitStructure.CAN_SJW = tsjw;  //CAN_SJW_1tq
    CAN_InitStructure.CAN_BS1 = tbs1;  //CAN_BS2_6tq
    CAN_InitStructure.CAN_BS2 = tbs2;  //CAN_BS1_8tq
    CAN_InitStructure.CAN_Prescaler = brp;  //3
