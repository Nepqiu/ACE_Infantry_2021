...
//	rc_ctrl->rc.ch[2] += (rc_ctrl->rc.ch[2] - 1024) * RC_YAW_SPEED;              //Y轴位置环量累加
//	rc_ctrl->rc.ch[2] = loop_fp32_constrain(rc_ctrl->rc.ch[2], -180.0f, 180.0f); //循环限幅
//	rc_ctrl->rc.ch[3] += (rc_ctrl->rc.ch[3] - 1024) * RC_PITCH_SPEED;            //P轴位置环量累加
}
